...
export const VaultABI = [
  ...
  {
    "type": "function",
    "name": "beneficiaryChangeUnlockTime",
    "inputs": [],
    "outputs": [
      {
        "name": "",
  ...
  {
    "type": "event",
    "name": "BeneficiaryChangeProposed",
    "inputs": [
      {
        "name": "newBeneficiary",
        "type": "address",
